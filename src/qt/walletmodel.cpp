...
CAmount WalletModel::getMintedBalance() const
{
...
void WalletModel::checkBalanceChanged()
{
    ...
    CAmount newMintedBalance = getMintedBalance();
    ...
    if(cachedBalance != newBalance || cachedStake != newStake || cachedUnconfirmedBalance != newUnconfirmedBalance || cachedImmatureBalance != newImmatureBalance ||
        cachedMintedBalance != newMintedBalance || cachedWatchOnlyBalance != newWatchOnlyBalance || cachedWatchUnconfBalance != newWatchUnconfBalance || cachedWatchImmatureBalance != newWatchImmatureBalance)
    {
        ...
        Q_EMIT balanceChanged(newBalance, newStake, newUnconfirmedBalance, newImmatureBalance, newMintedBalance,
