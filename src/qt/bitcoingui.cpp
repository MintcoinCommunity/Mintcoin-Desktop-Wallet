...
BitcoinGUI::BitcoinGUI(const NetworkStyle *networkStyle, QWidget *parent) :
    ...
    spinnerFrame(0)
{
    GUIUtil::restoreWindowGeometry("nWindow", QSize(940, 550), this);

    QString windowTitle = tr("MintCoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("MintCoin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateMintingWeights()
{
    ...
    if ((clientModel && (clientModel->getNumBlocks()-Checkpoints::GetTotalBlocksEstimate()>-3)) || !nWeight || !nNetworkWeight)
    {
        nWeight = 0;
